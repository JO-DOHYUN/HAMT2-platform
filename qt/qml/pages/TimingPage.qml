    ...
    ColumnLayout {
        ...
        Frame {
            ...
            RowLayout {
                ...
                anchors.margins: 8
                spacing: 6
                Label { text: "모델 " + appController.rulesCount + "건"; font.bold: true; color: "#243447" }
                Label { text: appController.rulesLoaded ? "모델 기준 비교" : "관찰 모드"; color: "#5b6673" }
                ...
                Label { text: "활성 " + appController.timingIssueCount + " / 누적 " + appController.timingCumulativeCount; color: "#5b6673" }
                Item { Layout.fillWidth: true }
                Button { text: "필터 초기화"; onClicked: clearFilters() }
                Button { text: "프레임 지우기"; onClicked: appController.clearFrames() }
                Label { text: "행 " + timingList.count; color: "#5b6673" }
            }
        }
        ...
        Frame {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Components.StatusBadge { text: "TIMING " + appController.timingLevel; kind: kindFromLevel(appController.timingLevel); uiScale: uiScale }
                    ...
                    Button { text: "최상위 주기"; enabled: appController.topTimingId !== ""; onClicked: appController.focusTimingId(appController.topTimingId) }
                    Item { Layout.fillWidth: true }
                    Label { text: appController.topTimingId !== "" ? (appController.topTimingId + " · " + appController.primaryIssueSummary) : appController.rootCauseSummary; color: "#607080"; elide: Text.ElideRight; Layout.preferredWidth: Math.round(430 * uiScale) }
                }
                Rectangle {
                    Layout.fillWidth: true
                    radius: 8
