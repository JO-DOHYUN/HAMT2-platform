    ...
    ColumnLayout {
        ...
        Frame {
            ...
            RowLayout {
                ...
                anchors.margins: 5
                spacing: 6
                Label { text: appController.selectedValueId !== "" ? ("선택 " + appController.selectedValueId) : (appController.modelActive ? "값 해석" : "값 / RAW"); font.bold: true; color: "#243447"; font.pixelSize: Math.round(11.0 * uiScale) }
                Label { text: "행 " + idList.count; color: "#5b6673"; font.pixelSize: Math.round(10.6 * uiScale) }
                ...
                Label { text: "활성 " + appController.valueIssueCount + " / 누적 " + appController.valueCumulativeCount; color: "#5b6673"; font.pixelSize: Math.round(10.6 * uiScale) }
                Item { Layout.fillWidth: true }
                Button { text: "필터 초기화"; onClicked: clearFilters() }
        ...
        Frame {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Components.StatusBadge { text: "VALUE " + appController.valueLevel; kind: kindFromLevel(appController.valueLevel); uiScale: uiScale }
                    ...
                    Button { text: "최상위 값"; enabled: appController.topValueId !== ""; onClicked: appController.focusValueId(appController.topValueId) }
                    Item { Layout.fillWidth: true }
                    Label { text: appController.topValueId !== "" ? (appController.topValueId + " · " + appController.primaryIssueSummary) : appController.rootCauseSummary; color: "#607080"; elide: Text.ElideRight; Layout.preferredWidth: Math.round(430 * uiScale) }
                }
                Rectangle {
                    Layout.fillWidth: true
                    radius: 8
