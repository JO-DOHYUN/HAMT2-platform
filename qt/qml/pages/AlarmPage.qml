    ...
    ColumnLayout {
        ...
        Frame {
            ...
            RowLayout {
                ...
                anchors.margins: 8
                spacing: 6
                Label { text: "값/버스 경보"; font.bold: true; color: "#243447" }
                Label { text: "주기 이슈는 주기 탭"; color: "#5b6673" }
                ...
                Label { text: "활성 " + appController.activeAlarmCount + " / 누적 " + appController.alarmCumulativeCount; color: "#5b6673" }
                Item { Layout.fillWidth: true }
                Button { text: "필터 초기화"; onClicked: clearFilters() }
                Button { text: "프레임 지우기"; onClicked: appController.clearFrames() }
                Label { text: "건수 " + alarmList.count; color: "#5b6673" }
            }
        }
        ...
        Frame {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Components.StatusBadge { text: "ALARM " + appController.alarmLevel; kind: kindFromLevel(appController.alarmLevel); uiScale: uiScale }
                    ...
                    Button { text: "최상위 경보"; enabled: appController.topAlarmId !== ""; onClicked: appController.focusAlarmId(appController.topAlarmId) }
                    Item { Layout.fillWidth: true }
                    Label { text: appController.topAlarmId !== "" ? (appController.topAlarmId + " · " + appController.primaryIssueSummary) : appController.rootCauseSummary; color: "#607080"; elide: Text.ElideRight; Layout.preferredWidth: Math.round(430 * uiScale) }
                }
                Rectangle {
                    Layout.fillWidth: true
                    radius: 8
