...
public:
    ...
    int controlTargetRpm() const { return m_controlTargetRpm; }
    double controlTargetSteeringDeg() const { return m_controlTargetSteeringDeg; }
    QString controlStatusSummary() const;
    QString controlBusSummary() const { return m_controlBusSummary; }
    QString controlLastCommandSummary() const { return m_controlLastCommandSummary; }
    QString controlLastAckSummary() const { return m_controlLastAckSummary; }
    QString controlLastAuditSummary() const { return m_controlLastAuditSummary; }
    QString controlEvidenceStatsSummary() const;
    StableMapListModel* controlEvidenceModel() { return &m_controlEvidenceModel; }
...
private:
    ...
    void sendControlKeepaliveTick(bool force = false);
    ...
    CanMonitorEvidence::BoardConnectionState m_boardConnectionState;
    bool m_controlArmed = false;
    bool m_controlTestRunning = false;
    int m_controlTargetBus = CanMonitorControl::kDefaultControlBus;
    ...
    bool m_controlTargetBusManualOverride = false;
    int m_controlTargetRpm = 0;
    double m_controlTargetSteeringDeg = 0.0;
    int m_controlCurrentSignedCommand = 0;
    int m_controlCurrentRpm = 0;
    double m_controlCurrentSteeringDeg = 0.0;
    quint8 m_controlCurrentMotorMode = 1;
    quint8 m_controlCurrentDrivingMode = 1;
    quint8 m_controlAliveCounter = 0;
    quint32 m_controlCommandCounter = 0;
    qint64 m_controlLastHeartbeatWallMs = 0;
    qint64 m_controlLastLeaseRenewWallMs = 0;
    qint64 m_controlLastBurstWallMs = 0;
    int m_controlPatternIndex = 0;
    QVector<ControlPatternStep> m_controlPatternSteps;
    quint64 m_controlEvidenceEventCounter = 0;
    ...
    quint64 m_controlTxAuditUnmatchedCount = 0;
    quint64 m_controlFeedbackObservedCount = 0;
    qint64 m_controlLastAckUiWallMs = 0;
    qint64 m_controlLastAuditUiWallMs = 0;
    QString m_controlStatusText = QStringLiteral("Control locked: typed stream + connect + arm required");
    QString m_controlLastCommandSummary = QStringLiteral("-");
    QString m_controlLastAckSummary = QStringLiteral("No CONTROL_ACK yet");
    QString m_controlLastAuditSummary = QStringLiteral("No CAN_TX_RAW audit yet");
