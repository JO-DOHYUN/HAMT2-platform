...
private slots:
    void clampsTargetsAndStepsTowardPositiveCommand() {
        ...
        QCOMPARE(first.steeringDeg, 1.0);
    ...
    void rampsSteeringWithoutOvershoot() {
        ...
        QCOMPARE(limiter.step().steeringDeg, 1.0);
        QCOMPARE(limiter.step().steeringDeg, 2.0);
    ...
    void handlesReverseDirectionWithoutOvershoot() {
        ...
        QCOMPARE(state.rpm, 250);
        QCOMPARE(state.steeringDeg, 1.0);
